                          ...
                          TitleOption(
                            data: removeGareDe(
                                Provider.of<GareProvider>(context)
                                    .selectedStation!
                                    .nom!),
                            color: const Color.fromRGBO(109, 76, 35, 1),
                            size: 14,
                            weight: FontWeight.w700,
                            maxLines: 1,
                            overflow: TextOverflow.clip,
                          ...
                          Container(
                            child: Column(
                                ...
                                children: [
                                  CircleAvatar(
                                    backgroundColor:
                                        const Color.fromRGBO(48, 183, 0, 0.14),
                                    minRadius: 25,
                          ...
                          Container(
                            child: Column(
                                ...
                                children: [
                                  CircleAvatar(
                                    backgroundColor:
                                        const Color.fromRGBO(186, 0, 0, 0.14),
                                    minRadius: 25,
                                    ...
                                    Row(
                                      children: [
                                        (Provider.of<GareProvider>(context,
                                            ...
                                            : Image.asset('images/check2.png'),
                                        const SizedBox(
                                          width: 4,
                                        ),
                                        TitleOption(
                                          data: Provider.of<GareProvider>(
                                                      context,
                                                      listen: false)
                                                  .parking!
                                              ? 'Disponible'
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Container(
          decoration: BoxDecoration(
              border: Border.all(color: const Color.fromRGBO(152, 162, 179, 1)),
              borderRadius: BorderRadius.circular(10),
              color:
                  isExpanded ? const Color.fromRGBO(242, 244, 247, 1) : Colors.white),
          child: ListTile(
            selectedColor: const Color.fromRGBO(242, 244, 247, 1),
